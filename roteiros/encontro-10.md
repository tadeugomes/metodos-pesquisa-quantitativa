...
| 2 | 40 min | Exposição dialogada: o gráfico como argumento; tipos de gráfico; integridade visual; normas de tabelas |
| 3 | 15 min | Intervalo |
| 4 | **45 min** | **Bloco de estatística: histograma, classes e escore z** (seção 4.E) |
| 5 | 60 min | Prática no Colab: gráficos com matplotlib sobre séries do Banco Central |
| 6 | 55 min | Oficina do projeto individual: limpeza, descritivas e primeiro gráfico da base própria |
...
### Bloco 2 – O gráfico como argumento (40 min)
...
### 4.E Bloco de estatística: histograma, classes e escore z (45 min)

**Referência:** Pinto e Silva (2020), *Estatística*, volume I, seção 2.4 e seções 8.1 a 8.1.3.
**Slides:** bloco "Estatística", sete telas, antes do divisor "Mão na massa".

O bloco dá o conteúdo estatístico que sustenta a aula de visualização: todo gráfico do dia é um
resumo que a turma já sabe calcular, desenhado.

Começar mostrando a equivalência: barras são a tabela de frequência do encontro 1; histograma é a
tabela com classes; boxplot são os cinco números do encontro 9. Essa correspondência costuma
resolver de uma vez a dúvida sobre "qual gráfico usar".

Apresentar as **classes** e a amplitude de classe, e demonstrar no projetor o efeito de mudar
`bins`. Rodar com 5, 10 e 30 e perguntar qual desenho conta a verdade. A resposta honesta é que
todos contam, e por isso a escolha se declara.

A **curva normal** entra como régua, não como teoria: a regra 68, 95, 99,7 e o escore z. O exemplo
da inadimplência, com z = 2,3, mostra como transformar "foi um mês atípico" em número. Avisar que
a régua pressupõe simetria, e que em variáveis com cauda longa se usam percentis.

**Dificuldade esperada:** aplicar o escore z em faturamento, que é assimétrico. Retomar o boxplot
do encontro 9 como diagnóstico prévio.
...
## 6. Oficina do projeto individual (55 min)
