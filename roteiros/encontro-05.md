...
**Seção 2 – Amostra aleatória simples (20 min).** Sortear com `df.sample(n=..., random_state=...)` amostras de 50, 200 e 800 empresas; comparar a receita média de cada amostra com a populacional. Adaptações: variar os tamanhos das amostras e observar o erro absoluto. A visualização-chave, código pronto, repete o sorteio de amostras de cada tamanho muitas vezes e mostra o histograma dos erros: o erro cai com o tamanho, mas com retornos decrescentes — a intuição visual do que a fórmula formaliza.
