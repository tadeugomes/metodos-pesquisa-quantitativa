...
| 2 | **20 min** | **Revisão pelas fichas de estatística da Unidade III** (seção 4.E) |
| 3 | 145 min | Realização da prova (Tarefas 1 a 4), com o professor em circulação |
| 4 | 15 min | Intervalo (no meio do bloco 3) |
| 5 | 45 min | Devolutiva parcial coletiva: correção comentada das quatro tarefas |
...
**Slides:** a tela "Revisão pelas fichas", logo após "Onde a turma costuma perder pontos".

Percorrer as fichas dos encontros 3, 4, 9, 10 e 11, e os fluxogramas de escolha de teste. Vinte
minutos, cerca de quatro por ficha.

Deixar explícita a exigência nova desta prova: **cada número calculado vem acompanhado de uma
frase de leitura em linguagem corrente**. Tarefa com código correto e sem a frase perde metade dos
pontos. É o mesmo critério do relatório final, antecipado aqui.

Fechar pelos três enganos que mais custam pontos, listados no slide: tratar "não rejeitar H0" como
prova de igualdade, comparar desvios padrão de escalas diferentes sem o coeficiente de variação, e
relatar a média de distribuição com cauda longa sem mencionar a mediana.

## 5. Condução da prática no notebook (145 min)
