...
|---|---|---|
| 1 | 15 min | Retomada do encontro 5: distribuição amostral, erro padrão e intervalo de confiança já vistos |
| 2 | 45 min | Exposição dialogada: da estimação ao teste; normal, TCL e IC em revisão rápida |
| 3 | 15 min | Intervalo |
| 4 | **45 min** | **Bloco de estatística: a lógica do teste de hipóteses** (seção 4.E) |
| 5 | 85 min | Prática no Colab: IC e teste t na base CVM; qui-quadrado no CEMPRE |
| 6 | 30 min | Aplicação à base do projeto individual |
...
### Bloco 2 – Normal e teorema central do limite (20 min)
...
### Bloco 2 – Estimação por ponto e por intervalo (15 min)
...
### Bloco 2 – A lógica dos testes de hipóteses (10 min)
...
### 4.E Bloco de estatística: a lógica do teste de hipóteses (45 min)

**Referência:** Silva e Samá (2021), *Estatística*, volume II, capítulos 5, 6 e 7 (com os
fluxogramas 5.9, 6.3 e 7.3) e seção 8.4.
**Slides:** bloco "Estatística", sete telas, antes do divisor "Mão na massa".

**Atenção à mudança de sequência.** Distribuição amostral, teorema central do limite e intervalo
de confiança passaram para o encontro 5. Os slides 5 a 10 deste encontro viram **retomada rápida**,
em 45 minutos, e não exposição nova. O tempo liberado vai todo para a lógica do teste e para a
prática, que antes ficava apertada.

O bloco começa pela **estatística de teste** lida como "a diferença medida em unidades de erro
padrão". Em seguida, a definição precisa de **valor-p**, e imediatamente o que ele não é. Vale
escrever as três leituras erradas no quadro e riscá-las uma a uma.

A **figura da decisão** é o centro: a distribuição sob H0, as caudas de 2,5% e o valor observado.
A tabela de erros tipo I e II entra aqui, com a observação de que reduzir um aumenta o outro.

A **tabela de escolha do teste** amarra com o encontro 3: o teste é escolhido pelo nível de
mensuração das variáveis. Classificação errada leva a teste errado, e o software não avisa.

Fechar pelo slide dos erros de interpretação, sobretudo significância contra relevância prática.
Esse ponto reaparece na Avaliação 2 e no relatório final.

**Dificuldade esperada:** a frase "não rejeitar H0 prova que os grupos são iguais". Corrigir toda
vez que aparecer, inclusive na devolutiva da prova.
