...
A partir daqui o bloco segue GIL (2022), capítulo 4 (seções 4.4 a 4.8) e, para os detalhes de delineamento, capítulos 7, 9 e 10. Apresentar primeiro o mapa de Gil (quinze delineamentos, dos quais sete produzem ou usam números) e situar as bases da disciplina como pesquisa documental com registros estatísticos. Em seguida, os planos experimentais de uma única variável e fatorial (cap. 7), com o exemplo de treinamento de vendas cruzado com modalidade presencial ou on-line, para mostrar que a interação pode esconder o efeito médio. O ponto mais útil para a turma é a "escada do rigor" com um mesmo caso de people analytics, o impacto de um treinamento: o antes e depois de um único grupo é, para Gil (com Campbell e Stanley), delineamento pré-experimental, em que cada participante é o seu próprio controle mas nada controla o tempo; treinados versus não treinados com pré-teste é o quase-experimento com grupo de controle não equivalente; o sorteio de quem treina agora e quem treina depois (lista de espera ou delineamento cruzado) é o experimento. Insistir que o antes e depois, tão usado em RH, vale como evidência inicial e não como prova de impacto.

Introduzir então os dois desenhos observacionais que a gestão importou das ciências da saúde. O estudo de coorte (seção 4.6 e cap. 9) acompanha um grupo com característica comum, comparando expostos e não expostos ao longo do tempo, sem sorteio da exposição; pode ser prospectivo ou retrospectivo; suas medidas são o risco relativo e o risco atribuível; seus limites são a ausência de aleatorização, o tamanho da amostra e a perda de participantes no seguimento. Exemplo de RH: coorte dos admitidos em um ano, com e sem onboarding estruturado, seguida por 24 meses quanto ao desligamento voluntário. Chamar atenção para o fato de que a prática do dia, a Demografia das Empresas, é ela própria uma coorte retrospectiva: empresas nascidas em cada ano, seguidas quanto à sobrevivência em um, dois e três anos. O estudo caso-controle (seção 4.7 e cap. 10) é retrospectivo e parte do desfecho: casos (quem apresentou o desfecho) e controles pareados (semelhantes em tudo, exceto no desfecho), comparados quanto à frequência da exposição, medida pela razão de chances. Exemplo de RH: analistas que pediram demissão versus analistas pareados que ficaram, verificando nos registros quem teve troca de gestor, falta de promoção ou ausência de treinamento; exemplo empresarial: empresas que fecharam versus sobreviventes do mesmo setor e porte. Destacar as vantagens (rápido, barato, viável para desfechos raros, gerador de hipóteses) e os cuidados (seleção dos controles, viés de memória, impossibilidade de estimar incidência). Fechar com a tabela comparativa experimento, coorte e caso-controle (quem forma os grupos, direção no tempo, medida típica, força causal) e com o teste de sanidade: quem começou listando quem saiu faz caso-controle; quem começou listando quem entrou e esperou faz coorte.
...
Sintetizar: o tipo de pesquisa decorre da pergunta; a mesma base de dados serve a perguntas descritivas e correlacionais; e o pandas é a ferramenta de transformar pergunta em filtro, agrupamento e gráfico. Tarefa para o encontro 3: ler GIL (2022), capítulo 4 (seções 4.4 a 4.8, sobre os delineamentos vistos em aula) e capítulos 2 e 3 (problema e hipóteses, que preparam o encontro seguinte), e trazer por escrito uma pergunta de pesquisa sobre tema empresarial ou econômico de interesse pessoal, que será trabalhada em aula.

## 8. Referência do encontro

GIL, Antonio Carlos. **Como elaborar projetos de pesquisa**. 7. ed. Barueri: Atlas, 2022. Capítulo 4 (seções 4.4 a 4.8) e capítulos 7, 9 e 10.
